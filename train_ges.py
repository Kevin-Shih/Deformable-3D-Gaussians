...
import sys
from scene import Scene, GaussianModel, LaplacianModel, DeformModel
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations):
    ...
    for iteration in range(1, opt.iterations + 1):
        ...
        # Render
        render_pkg_re = render_laplacian(viewpoint_cam, gaussians, pipe, background, d_xyz, d_rotation, d_scaling, dataset.is_6dof)
